...
if (!function_exists('menu_builder')) {
     ...
     * @return  html
     */
    function menu_builder($slug, $parentClass = null, $childClass = null,$withChildren=true,$withActive=true, $parentTag = null, $childTag = null)
    {
        ...
        return $menu->render($parentTag, $childTag, $parentClass, $childClass,$withChildren,$withActive);
    }
}
